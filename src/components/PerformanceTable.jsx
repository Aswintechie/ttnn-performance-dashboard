        ...
        <table className="min-w-full relative">
          <thead>
            <tr className="border-b border-gray-200">
              <SortableHeader sortKey="operation_name" className="table-sticky-left-0 bg-gray-50 text-center border-r border-gray-200">
                Operation
              </SortableHeader>
              <th className="table-header text-center table-sticky-left-200 bg-gray-50 border-r border-gray-200">Category</th>
          ...
          <tbody>
            {filteredAndSortedData.map((operation, index) => (
              <tr key={operation.operation_name} className="hover:bg-gray-50 transition-colors duration-150 group">
                <td className="table-cell table-sticky-left-0 bg-white group-hover:bg-gray-50 font-medium text-gray-900 border-r border-gray-200 text-center transition-colors duration-150">
                  {operation.operation_name}
                </td>
                <td className="table-cell text-center table-sticky-left-200 bg-white group-hover:bg-gray-50 border-r border-gray-200 transition-colors duration-150">
